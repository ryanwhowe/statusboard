...
class PayDate {
    ...
    const EMPLOYER_SHORTNAME_TRUECAR = 'TrueCar';
    const EMPLOYER_SHORTNAME_IVES = 'Ives';
    const EMPLOYER_SHORTNAME_AVENTION = 'Avention';
    const EMPLOYER_SHORTNAME_JNJ = 'JNJ';

    const EMPLOYER_LONGNAME_TRUECAR = 'TrueCar, Inc.';
    const EMPLOYER_LONGNAME_IVES = 'Ives Group, Inc.';
    const EMPLOYER_LONGNAME_AVENTION = 'Avention, Inc.';
    const EMPLOYER_LONGNAME_JNJ = 'JNJ Industries, Inc.';
    ...
    public static function getEmployerByConstant(int $employerConstant, bool $short_name = true) {
        switch ($employerConstant) {
            case self::EMPLOYER_JNJ:
                return ($short_name) ? self::EMPLOYER_SHORTNAME_JNJ : self::EMPLOYER_LONGNAME_JNJ;
                break;
            case self::EMPLOYER_AVENTION:
                return ($short_name) ? self::EMPLOYER_SHORTNAME_AVENTION : self::EMPLOYER_LONGNAME_AVENTION;
                break;
            case self::EMPLOYER_IVES:
                return ($short_name) ? self::EMPLOYER_SHORTNAME_IVES : self::EMPLOYER_LONGNAME_IVES;
                break;
            case self::EMPLOYER_TRUECAR:
                return ($short_name) ? self::EMPLOYER_SHORTNAME_TRUECAR : self::EMPLOYER_LONGNAME_TRUECAR;
                break;
            case null:
                return null;
                break;
    ...
    /**
     * Generate an array of pay dates for the year given.  This is used in the bulk processor to add pay dates to the
     * calendar table each year.
     *
     * @param int   $year
     * @param array $holiday
     *
    ...
    /**
     * Generate all the pay dates for a given month passed in by the date.
     *
     * @param int|null $employer
     * @param DateTime $date
     * @param array    $holiday
     *
     * @return array
